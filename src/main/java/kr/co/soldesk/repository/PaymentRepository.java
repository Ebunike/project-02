...
public class PaymentRepository {
	...
	public void addSales(int seller_index, int order_detail_finalPrice) {
		// Seller 테이블에 sales 업데이트
		paymentMapper.addSales(seller_index, order_detail_finalPrice);
		
		// sales 테이블에 매출 데이터 추가 (신규 추가)
		paymentMapper.insertSalesRecord(seller_index, order_detail_finalPrice);
	}
