...
import kr.co.soldesk.repository.SearchRepository;
...
public class SearchService {
	 ...
	 public List<OnedayBean> OnedaySearch(String result){ 
		 return searchrepository.OnedaySearch(result); 
	 }
	 public List<ItemBean> KitSearch(String result){
		 return searchrepository.KitSearch(result); 
	 }
	 public List<OpenRecipeBean> OpenRecipeSearch(String result){ 
		 return searchrepository.OpenRecipeSearch(result); 
	 }
