...
public interface PaymentMapper {
    ...
    //판매자 sales를 amount만큼 올려주기. 관리자 or 판매자 매출 확인용
  	...
  	// 새로 추가: sales 테이블에 매출 데이터 추가
  	@Insert("INSERT INTO sales (sales_id, seller_index, sale_date, total_amount) VALUES (sales_seq.NEXTVAL, #{seller_index}, SYSDATE, #{amount})")
  	void insertSalesRecord(@Param("seller_index") int seller_index, @Param("amount") int amount);
