...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        const dailyData = [
            ['날짜', '매출액(원)', { role: 'style' }],
            ['3월 27일', Math.round(currentSales * 0.7), '#76A7FA'],  // 월요일
            ['3월 28일', Math.round(currentSales * 0.8), '#76A7FA'],  // 화요일
            ['3월 29일', Math.round(currentSales * 0.9), '#76A7FA'],  // 수요일
            ['3월 30일', Math.round(currentSales * 0.75), '#76A7FA'], // 목요일
            ['3월 31일', Math.round(currentSales * 1.1), '#76A7FA'],  // 금요일
            ['4월 1일', Math.round(currentSales * 1.2), '#76A7FA'],   // 토요일
            ['4월 2일', currentSales, '#3366CC']                      // 일요일 (오늘)
        ];
