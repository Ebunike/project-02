    ...
    <div class="container">
        <div class="edit-form">
            ...
            <form action="<c:url value='/oneday/edit'/>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="sellerIndex" value="${oneday.seller_index}">
                
                <div class="form-group">
                    <label for="themeIndex" class="required">테마</label>
                    <select name="themeIndex" id="themeIndex" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="onedayName" id="onedayName" class="form-control" 
                ...
                <div class="form-group">
                    ...
                    <div class="textarea-container">
                        <textarea name="onedayInfo" id="onedayInfo" class="form-control" 
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="onedayDate" id="onedayDate" class="form-control" 
                ...
                <div class="form-group">
                    ...
                    <div class="time-group">
                        <input type="time" name="onedayStart" id="onedayStart" value="${oneday.oneday_start}" required>
                        <span>부터</span>
                        <input type="time" name="onedayEnd" id="onedayEnd" value="${oneday.oneday_end}" required>
                        <span>까지</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="onedayLocation" id="onedayLocation" class="form-control" 
                           value="${oneday.oneday_location}" required maxlength="200">
                </div>
                
                <div class="form-group">
                    <label for="onedayPrice" class="required">수강료</label>
                    <input type="number" name="onedayPrice" id="onedayPrice" class="form-control" 
                           value="${oneday.oneday_price}" required min="0" max="1000000">
                </div>
                
                <div class="form-group">
                    <label for="onedayPersonnel" class="required">정원</label>
                    <input type="number" name="onedayPersonnel" id="onedayPersonnel" class="form-control" 
